...
(function (global) {
  ...
  var HELP = {
    ...
    strategy: {
      ...
      d: '배치 산출은 <b>최적화 알고리즘</b>입니다. 난수를 쓰지 않으므로 같은 조건이면 ' +
         ...
         '위 칸을 누르면 그 기준으로 다시 짭니다.'
    },
    weekendImpact: {
      t: '왜 배치를 평일/주말 따로 안 짜나요',
      d: '정류장·똑버스·증편은 <b>물리 시설</b>입니다. 평일에만 짓고 주말엔 없앨 수 없으므로, ' +
         '평일용 배치안과 주말용 배치안을 따로 만들어도 실제로 지을 수 있는 건 하나뿐입니다.<br><br>' +
         '그래서 배치를 고르는 단계부터 <b>평일과 주말 효과를 함께 계산</b>해 하나를 정합니다 — ' +
         '이 카드는 그렇게 고른 배치 하나가 평일과 주말에 각각 얼마나 도움이 되는지를 ' +
         '나눠서 보여줍니다. 위 숫자는 부가 정보가 아니라 애초에 배치를 고를 때 이미 ' +
         '반영된 근거입니다.'
    },
    costBasis: {
      t: '비용 비교 기준',
  ...
  var TOUR = [
    ...
    { page: 'simulation', targets: ['#tools', '#btnRecommend'],
      text: '직접 수단을 배치하거나 최적화 추천을 받아 확인하고 시나리오를 저장해 보세요' },
