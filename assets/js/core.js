...
(function (global) {
  ...
  var ICONS = {
    ...
    /* 배치 수단 3종(정류장 신설·똑버스·증편) — 같은 자리(simulation.js 툴바·배치
       목록)가 그동안 ●◆▲ 글자로 때워져 있었습니다. map.js 는 이미 이 세 수단을
       원·마름모·삼각으로 그려 색맹·흑백 대비까지 신경 썼는데("예전에는 셋 다 같은
       보라색 글자 기호(●◆▲)라 구분이 안 됐습니다"), 지도 옆 버튼만 그 이전
       상태로 남아 있었던 것 — 같은 모양 언어로 다시 그립니다. */
    stop: '<circle cx="12" cy="12" r="7.5"/>',
    drt:  '<path d="M12 4 20 12 12 20 4 12Z"/>',
    freq: '<path d="M12 3.5 20 18.5 4 18.5Z"/>'
  };
